...
I led the UX consolidation effort to integrate CyberX into Microsoft's ecosystem: translating OT security concepts into a unified Microsoft taxonomy, redesigning CyberX's core interfaces using the Microsoft Fluent Design System, and standardizing controls, components, and layout patterns across both products. Hybrid deployment workflows were rebuilt to align with Azure's existing mental models.
