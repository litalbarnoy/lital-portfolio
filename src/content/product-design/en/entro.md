...
Rather than presenting a long inventory and leaving the user to sort it, the platform opens on the practical question of **what is risky right now, and why**, and only then unfolds into depth: who created the secret, which systems it can reach, when it was last used, and what breaks if it is revoked.
